...
allDat$year_temp <- 1
allDat[year==2011&temp!="Hot"]$year_temp <- 2
allDat[year==2012&temp=="Hot"]$year_temp <- 3
allDat[year==2012&temp!="Hot"]$year_temp <- 4
allDat[year==2013&temp=="Hot"]$year_temp <- 5
allDat[year==2013&temp!="Hot"]$year_temp <- 6
